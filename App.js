...
// import React from 'react';
// import { StyleSheet, View, YellowBox, Slider, Button, Text } from 'react-native';
// import AppNavigator from './app/config/AppNavigator';
// import { Constants, AppLoading, Audio, Font } from 'expo';
// import { Recorder, Player, } from 'react-native-audio-player-recorder-no-linking';

// export default class App extends React.Component {
//   state = {
  
//     audioFile: "file:///data/user/0/host.exp.exponent/cache/ExperienceData/%2540anonymous%252FNotes-76864e05-eaeb-492c-8a70-10015e60de63/Audio/recording-a517cad1-cbfe-4d18-82e5-3fcfc14b9738.m4a"
//   };
...
//   recorderComplete = (name) => {
//     // this.setState({ audioFile: name.uri });
//     // console.log("tfhhhhhhtfhf", name.uri)
//   }
//   render() {
//     return (
...
//         <Player
//           style={{ flex: 1 }}
//           // onComplete={(name)=>this.recorderComplete(name)}
